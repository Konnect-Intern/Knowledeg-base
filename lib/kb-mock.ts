...
export const KB_SOURCES: KbSource[] = [
  {
    ...
    documents: [
      // 🌟 NEW: Root URL Document
      {
        ...
        status: "INDEXED",
        extracted_text: `# Cliniko: Practice Management Software\n\nCliniko is a complete practice management application used by thousands of healthcare practitioners in more than 95 countries.\n\n## Everything you need to run your clinic\n\nManage schedules, treatment notes, invoices, payments, and a lot more. It works great for solo practitioners, large multi-location teams, and anything in between.\n\n### Core Features\n- **Appointments:** Easy-to-use calendar for bookings and scheduling.\n- **Treatment Notes:** Secure, customizable, and comprehensive.\n- **Invoices & Payments:** Streamlined billing to help you get paid faster.\n- **Telehealth:** Built-in secure video consultations at no extra cost.\n- **Online Bookings:** Let your patients book themselves 24/7.\n\n[Start your free 30-day trial today]`,
